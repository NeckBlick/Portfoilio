...
export default function CardTecnologias({ icon, title, description }) {
  return (
    <div className="flex flex-col items-center gap-5 lg:gap-6 shadow-lg rounded-md sm:w-full lg:h-96 h-96 lg:w-[30rem] px-4  py-4 overflow-hidden border-2  sm:ml-6">
      {icon}
